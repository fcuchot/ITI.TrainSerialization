...
namespace ITI.TrainSerialization.Tests
{
    ...
    public class PublicModelChecker
    {
        ...
        {
            var model = XElement.Parse( @"<Assembly Name=""ITI.TrainSerialization"">
  <Types>
    <Type Name=""ITI.TrainSerialization.Classroom"">
    ...
    <Type Name=""ITI.TrainSerialization.Pupil"">
    ...
    <Type Name=""ITI.TrainSerialization.School"">
    ...
    <Type Name=""ITI.TrainSerialization.Teacher"">
